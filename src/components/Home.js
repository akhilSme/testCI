...
import {
  ...
  fetchWeatherDetailsByUpdatedDate,
  fetchWeatherDetailsByRangeDate,
} from "../util/ApiUtil";
...
const Home = () => {
  ...
  const handleChangeByUpdatedDate = (event) => {
    ...
    fetchWeatherDetailsByUpdatedDate(updatedDateOn)
      .then((response) => {
        setWeatherDetails(response);
      })
      .catch((error) => {
  ...
  const handleChangeByRangeDate = (event) => {
    ...
    if (fromDate !== "" && toDate !== "") {
      ...
      fetchWeatherDetailsByRangeDate(isoFromDate, isoToDate)
        .then((response) => {
          setWeatherDetails(response);
        })
        .catch((error) => {
